<template>
  <div class="echarts" :style="`min-height: ${minHeight}px; max-height: ${maxHeight}px;`" />
</template>
...
export default {
  ...
  methods: {
    ...
    init (options) {
      ...
      const chart = echarts.init(this.$el, this.theme || (this.dark ? 'dark' : undefined), this.initOptions)
